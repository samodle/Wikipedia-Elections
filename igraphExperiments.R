...
print(head(igraph::all_simple_paths(network3, 1)))


message(paste('-'))
message(paste('Articulation Points:'))
print(igraph::articulation_points(network3))
...
print(igraph::mean_distance(network3, directed = TRUE, unconnected = TRUE))


message(paste('-'))
message(paste('Incident edges of a vertex in a graph:'))
print(igraph::incident(network3, 1))
...
print(igraph::is_chordal(network3))
